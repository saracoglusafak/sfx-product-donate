...
// },100);
    ...
    _body.on('click', '.sfxplugin-remove-closest', function (e) {
        e.preventDefault();
        var _this = $(this);
    ...
    var _mediaUploader = [];
    $('.sfxplugin-select-image').click(function (e) {
        e.preventDefault();
        var _this = $(this);
        var _data = _this.data();
        ...
        _mediaUploader[_data.id].on('select', function () {
            ...
            if (_data.multiple) {
                ...
                for (var index = 0; index < _elements.length; index++) {
                    ...
                    var ADD = '<div id="sfxplugin-image-' + _elements[index].id + '" class="sfxplugin-image col-4">';
                    ADD += '<a href="#" class="sfxplugin-remove-closest" data-remove-closest=".sfxplugin-image"></a>';
                ...
                var ADD = '<div id="sfxplugin-image-' + _element.id + '" class="sfxplugin-image col-4">';
                ADD += '<a href="#" class="sfxplugin-remove-closest" data-remove-closest=".sfxplugin-image"></a>';
